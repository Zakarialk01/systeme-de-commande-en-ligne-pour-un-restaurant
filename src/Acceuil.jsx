      ...
      <footer class="footer">
        <div class="max-w-screen-xl px-4 pb-8 mx-auto pt-36 sm:px-6 lg:px-8">
          <div class="max-w-3xl mx-auto text-center">
            ...
            <Link
              class="inline-flex items-center bg-indigo-600 px-5 py-3 mt-8 font-medium  rounded-full hover:bg-indigo-800 "
              to="/Menu"
            >
              {" "}
              Accéder au menu
          ...
          <div class="pt-28 border-t   border-white border-opacity-25 sm:items-center sm:justify-between mt-36 sm:flex">
